...
You can obtain an API key by filling out the following form: https://forms.gle/R5RvCNYN8ANsamUFA.

After submitting the form, an API key will be sent via email. The API key is valid for up to 7 days.
